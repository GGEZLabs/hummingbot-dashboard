...
def main_page():
    return [st.Page("frontend/pages/landing.py", title="GGEZ1 Hummingbot Dashboard", icon="📊", url_path="landing")]
...
def public_pages():
    return {
        "Config Generator": [
            ...
            st.Page(
                "frontend/pages/config/xemm_controller/app.py", title="XEMM Controller", icon="⚡️", url_path="xemm_controller"
            ),
        ],
        "Data": [
            st.Page(
                "frontend/pages/data/download_candles/app.py", title="Download Candles", icon="💹", url_path="download_candles"
            ),
        ],
        "Community Pages": [
